...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(telecom1.toString());
        System.out.println(telecom2.toString());
        System.out.println(telecom3.toString());
        System.out.println(webPageAddress1.toString());
        System.out.println(webPageAddress2.toString());
        System.out.println(webPageAddress3.toString());
        System.out.println(geographicAddress1.toString());
        System.out.println(geographicAddress2.toString());
        System.out.println(geographicAddress3.toString());
        System.out.println(generalDeliveryAddress1.toString());
        System.out.println(generalDeliveryAddress2.toString());
        System.out.println(generalDeliveryAddress3.toString());
        System.out.println(postOfficeBoxAddress1.toString());
        System.out.println(postOfficeBoxAddress2.toString());
        System.out.println(postOfficeBoxAddress3.toString());

        System.out.println(email1.equals(email2));
        System.out.println(email2.equals(email3));
        System.out.println(webPageAddress1.equals(email3));
        System.out.println(email3.equals(email3));
        ...
        traceObsoleteAddresses(listOfAddresses, 2020, 03, 03);
